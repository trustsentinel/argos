...
matter to us. Thank you for helping keep `argos` and its users safe.
...
- **Preferred:** GitHub private reporting — the **"Report a vulnerability"** button
  ...
  (<https://github.com/trustsentinel/argos/security/advisories/new>).
...
`argos` is pre-1.0: security fixes land on the latest `main` and the most recent
